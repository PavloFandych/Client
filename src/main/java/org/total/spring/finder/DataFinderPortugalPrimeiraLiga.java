...
public final class DataFinderPortugalPrimeiraLiga extends DataFinder {
    ...
    protected String getUrl() {
        try {
            ...
            final String api = credentials.getProperty("apiPRT_PRIMEIRA_LIGA");
    ...
    public List<Result> findResults() {
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                final Team homeTeam = getPortugalTeamDAO().findByTeamName((String) item.get(Constants.HOME_TEAM_NAME));
                final Team awayTeam = getPortugalTeamDAO().findByTeamName((String) item.get(Constants.AWAY_TEAM_NAME));
